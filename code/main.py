...
#!jeu de donnée
haut=[(206.33,6499241.41),(203.97,251.15),(204.31,263.84),(206.70,272.88),(212.03,279.71),(222,61,284.91),(232.22,290.63),(239.55,294.74),(249.78,297.58),(260.79,303.74),(274.38,305.33),(281.76,308.50),(293.87,311.43),(301.70,315.09),(310.87,310,37),(314.50,313,36),(325.13,317.62),(334.95,319.03),(353.73,320.41),(459.11,244.71),(474.84,260.49),(499.05,286.06),(519.74,296.45),(542.77,307.41),(565.51,314.61),(586.88,320.80),(607.24,328.35),(625.95,331.12),(647.86,335.93),(658.19,356.15)]                          
alt=[(1471.76,1480.02,1491.53),(1471.8,1479.8,1490.47),(1471.69,1481.34,1489.87),(1471.05,1483.27,1488.63),(1468.6,1483.27,1488.31),(1470.75,1478.26,1488.12),(1475.95,1476.36,1485.98),(1479.3,1475.29,1485.35),(1477.41,1475.96,1485.24),(1474.47,1476.59,1485.26),(1478.56,1477.29,1486.13),(1480.5,1484.23,1489.44),(1484.48,1486.63,1491.67),(1487.09,1489.81,1493.79),(1489.6,1494.7,1495.66),(1491.55,1502.85,1501,45),(1498.02,1510.37,1505.37),(1502,78,1516.67,1516.06),(1512.61,1523.76,1517.99),(1528.16,1548.74,1539.47),(1559.79,1576.29,1553.55),(1581.49,1593.06,1588.67),(1602.08,1614.81,1619.49),(1623.89,1633.56,1642.55),(1639.27,1651.58,1658.95),(1663.26,1687.01,1671.61),(1689.06,1703.95,1693.73),(1741.61,1720.85,1720.16),(1755.46,1738.52,1749.21),(1786.45,1774.83,1778.1)]
bat=[(384.16,88,90),(386.55,97.93),(387.41,99.85),(389.87,107.48),(539.52,112.26),(395.26,112.90),(402.2,115.21),(406.97,123.89),(412.74,131.21),(418.29,133.36),(425.98,139.83),(430.75,148.51),(422.82,166.44),(429.40,166.76),(436.81,169.46),(439.14,179.90),(445.33,188.18),(451.13,204.89),(452.18,212.45),(378.34,327.69),(423.39,331.26),(458.10,334.33),(486.97,341.35),(514.76,351.14),(534.16,359.11),(560.12,367.87),(580.33,378.70),(618.12,396.01),(636.18,402.51),(652.0,406.55)]
...
largeur=[np.sqrt((haut_x[i]-bat_x[i])**2+(haut_y[i]-bat_y[i])**2) for i in range(len(haut))]#largeur entre les deux extrémités
pente = [np.arctan((alt_m[i]-alt_m[i+1])/(haut_x[i]-haut_x[i+1]))  for i in range(len(alt_m)-1)]#pente pour chaque point par rapport à l'horizontal
pente_tan = [np.tan(pente[i]) for i in range(len(pente))]



#!epaisseur de la neige
alt = alt[len(alt)-1] #altitude de départ
d0_period = 1.5
...
#!valeurs initiales
B0 = 54.07  #plus grande largeur d ela zone de départ
...
def p(c,amp):
    ...
    xu2 = 0.7 * (epsi / g) * dp
    if xu1 >= xu2 - xu2*0.15 and xu1 <= xu2 + xu2*0.15:
        return vp, dp
    else:
        return p(c,10+amp)
...
def arret(dp, vp, phi_s):
    ...
    s = (ds * epsi)/(2 * g) * np.log(1 + (vp ** 2) / v2)
    return (ds,s)
...
for i in range(30,90):
    v =(longueur / np.cos((90-i) * (np.pi / 180))) * epaisseur * prix_m3 
    xp.append(i)
    yp.append(v)
plt.plot(xp,yp)
